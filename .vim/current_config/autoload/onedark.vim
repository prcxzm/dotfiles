...
let s:colors = {
      ...
      \ "green": get(s:overrides, "green", { "gui": "#A7C080", "cterm": "114", "cterm16": "2" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#89BEBA", "cterm": "39", "cterm16": "4" }),
      ...
      \ "black": get(s:overrides, "black", { "gui": "#323D43", "cterm": "235", "cterm16": "0" }),
      \ "foreground": get(s:overrides, "foreground", { "gui": "#ABB2BF", "cterm": "145", "cterm16": "NONE" }),
      \ "background": get(s:overrides, "background", { "gui": "#323D43", "cterm": "235", "cterm16": "NONE" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#323D43", "cterm": "236", "cterm16": "0" }),
